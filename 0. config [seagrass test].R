...
dataRecordsFile <- "/media/Hammerhead/Data/Distribution Models/Global distribution of seagrasses/Data/Records/finalDatasetSeagrassesReduced.csv"
...
depthTraits <- NULL # "/Data/Traits/coldWaterCorals.csv" 
minDepth <- 0 # NULL
maxDepth <- 20 # NULL
maxDepthBuffer <- 0
minDepthBuffer <- 0
